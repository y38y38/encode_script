...
do
    ...
    $HEVC_DIR/bin/TAppEncoderStatic -i ${INPUT_FILE} -c $HEVC_DIR/cfg/encoder_randomaccess_main.cfg -fr 29.97 -f $FRAME_NUM -wdt 352 -hgt 288 --InputBitDepth=8 --OutputBitDepth=8  -q ${QP} -b ./${OUTPUT_DIR}/${OUTPUT_FILE}.bin > ./${OUTPUT_DIR}/${OUTPUT_FILE}_encode_result.txt
